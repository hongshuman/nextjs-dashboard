...
import { inter, ubuntu, wenkai } from '@/app/ui/fonts';
    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-3/5 md:px-20">
          ...
          {/* <p className={`${h8nFont.className} antialiased bg-red-800`}> */}
          <p className={`${wenkai.className} antialiased bg-red-500`}>
            <span className={styles.zhao_men_fu}> 赵孟頫博学多才，工古文诗词，通音律，精鉴赏。在书法上，他精于正书、行书和小楷，其书圆转遒丽，被人称为“赵体” </span>
          </p>
